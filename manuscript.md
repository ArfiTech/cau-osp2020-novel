...
그렇게 집사는 자신의 일에 더 집중하게 되어만 가는 듯 했고, 톰은 집사가 깨우지 않았기에 일어나는 시간이 더욱 늦어갔다.
그런 하루들이 반복된 결과 톰은 저녁에 일어나는 생활 패턴이 되었다. 이는 집사를 만나 어리광을 부리기는 당연히 불가능했다.
예전에는 그렇게 챙겨줬으면서 갈수록 자신을 외면하는 듯한 느낌을 받는 톰. 그래도 집에는 있게 해주니 그러려니 하지만, 집사에 대한 그리움은 식어만 가고 혼자서 생활하는 시간이 늘어 자연스럽게 혼자 있는 시간이 더 늘어갔다. 오늘도 그런 저녁을 맞이한 것이었다.
